...
SELECT * 
FROM oc_address 
WHERE address_id = (SELECT payment_address_id FROM oc_order WHERE order_id = {ORDER_ID});
Validaciones
firstname / lastname
...
SELECT * 
FROM oc_address 
WHERE address_id = (SELECT shipping_address_id FROM oc_order WHERE order_id = {ORDER_ID});
Validaciones
firstname / lastname
